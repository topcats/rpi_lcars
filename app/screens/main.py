...
class ScreenMain(LcarsScreen):
    def setup(self, all_sprites):
        ...
        #all_sprites.add(LcarsText(colours.BLACK, (444, 612), "192 168 0 3"), layer=1)
        all_sprites.add(LcarsText(colours.BLACK, (444, 612), get_ip_address('eth0')), layer=1)
